	...
	<div class="container">
		...
		<form method="post">
			<table class="table table-bordered " style="background-color: #96D4D4;">
				...
				<tr>
					<td>LastName:</td>
					<td><input type="text" name="lastname" required="required"></input></td>

				</tr>
				<tr>
					<td>UserName:</td>
					<td><input type="text" name="username" required="required"></input></td>
				</tr>
				<tr>
					<td>Password:</td>
				...
				<tr>
					<td>Address:</td>
					<td><input type="text" name="address" required="required"></input>
					</td>
				</tr>
				<tr>
